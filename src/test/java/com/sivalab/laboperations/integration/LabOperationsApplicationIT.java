...
@Testcontainers
public class LabOperationsApplicationIT extends AbstractIntegrationTest {
    ...
    public void testGetTestTemplateById() {
        ...
        ResponseEntity<Map> response = restTemplate.getForEntity(
            "/test-templates/" + createdTemplateId, Map.class);
    ...
    public void testSearchTestTemplates() {
        ResponseEntity<Object[]> response = restTemplate.getForEntity(
            "/test-templates/search?name=Blood", Object[].class);
    ...
    public void testUpdateTestTemplate() {
        ...
        ResponseEntity<Map> response = restTemplate.exchange(
            "/test-templates/" + createdTemplateId,
    ...
    public void testGetVisitById() {
        ...
        ResponseEntity<Map> response = restTemplate.getForEntity(
            "/visits/" + createdVisitId, Map.class);
    ...
    public void testGetVisitsByStatus() {
        ResponseEntity<Object[]> response = restTemplate.getForEntity(
            "/visits?status=pending", Object[].class);
    ...
    public void testSearchVisitsByPhone() {
        ...
        restTemplate.postForEntity("/visits", visitRequest, Map.class);

        // Now search for visits by phone
        ResponseEntity<Object[]> response = restTemplate.getForEntity(
            "/visits/search?phone=8888888888", Object[].class);
    ...
    public void testUpdateVisitStatus() {
        ...
        try {
            ResponseEntity<Map> response = restTemplate.exchange(
                "/visits/" + createdVisitId + "/status?status=in-progress",
    ...
    public void testGetTestsForVisit() {
        ...
        ResponseEntity<Object[]> response = restTemplate.getForEntity(
            "/visits/" + createdVisitId + "/tests", Object[].class);
    ...
    public void testUpdateTestResults() {
        ...
        ResponseEntity<Map> response = restTemplate.exchange(
            "/visits/" + createdVisitId + "/tests/" + createdTestId + "/results",
    ...
    public void testApproveTestResults() {
        ...
        ResponseEntity<Map> response = restTemplate.exchange(
            "/visits/" + createdVisitId + "/tests/" + createdTestId + "/approve",
            HttpMethod.PATCH, entity, Map.class);
    ...
    public void testVisitStatusUpdateLogic() {
        ...
        restTemplate.exchange(
            "/visits/" + testVisitId + "/tests/" + test1Id + "/results",
        ...
        restTemplate.exchange(
            "/visits/" + testVisitId + "/tests/" + test1Id + "/approve",
        ...
        restTemplate.exchange(
            "/visits/" + testVisitId + "/tests/" + test2Id + "/results",
            HttpMethod.PATCH, resultsEntity, Map.class);

        restTemplate.exchange(
            "/visits/" + testVisitId + "/tests/" + test2Id + "/approve",
            HttpMethod.PATCH, approveEntity, Map.class);
    ...
    public void testGenerateBill() {
        ...
        ResponseEntity<Map> response = restTemplate.getForEntity(
            "/billing/visits/" + createdVisitId + "/bill", Map.class);
    ...
    public void testGetBillById() {
        ...
        ResponseEntity<Map> response = restTemplate.getForEntity(
            "/billing/" + createdBillId, Map.class);
    ...
    public void testGetRevenueForPeriod() {
        ...
        ResponseEntity<Double> response = restTemplate.getForEntity(
            "/billing/revenue?startDate=" + startDate + "&endDate=" + endDate,
            Double.class);
    ...
    public void testGetNonExistentTestTemplate() {
        ResponseEntity<String> response = restTemplate.getForEntity(
            "/test-templates/99999", String.class);
    ...
    public void testCreateVisitWithInvalidData() {
        ...
        ResponseEntity<String> response = restTemplate.postForEntity(
            "/visits", visitRequest, String.class);
    ...
    public void testCreateTestTemplateWithInvalidData() {
        ...
        ResponseEntity<String> response = restTemplate.postForEntity(
            "/test-templates", templateRequest, String.class);
    ...
    public void testSearchVisitsWithEmptyPhone() {
        ResponseEntity<String> response = restTemplate.getForEntity(
            "/visits/search?phone=", String.class);
    ...
    public void testSearchTestTemplatesWithEmptyName() {
        ResponseEntity<String> response = restTemplate.getForEntity(
            "/test-templates/search?name=", String.class);
    ...
    public void testUpdateVisitStatusWithInvalidStatus() {
        ...
        ResponseEntity<String> response = restTemplate.exchange(
            "/visits/" + createdVisitId + "/status?status=invalid-status",
    ...
    public void testGetVisitsByInvalidStatus() {
        ResponseEntity<String> response = restTemplate.getForEntity(
            "/visits?status=invalid-status", String.class);
    ...
    public void testVisitCountByStatusWithSpecificData() {
        ...
        visitRequest2.put("patientDetails", visitRequest2);
        ...
        restTemplate.patchForObject(
            "/visits/" + visitId2 + "/status?status=in-progress",
            null,
            Map.class);
